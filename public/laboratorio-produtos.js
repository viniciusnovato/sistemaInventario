...
console.log('🔧 [DEBUG] laboratorio-produtos.js carregado!', new Date().toISOString());

// Função de teste global
window.testEditProduct = function(id) {
    console.log('🧪 [TEST] Função de teste chamada com ID:', id);
    alert('TESTE: Função chamada com ID ' + id);
};
        ...
        <tr>
            ...
            <td>
                <div class="action-buttons">
                    ...
                    <button class="btn btn-sm btn-warning btn-icon tooltip" onclick="window.testEditProduct('${product.id}')" title="Editar">
                        ✏️
                    </button>
...
async function saveProduct() {
    console.log('💾 [DEBUG] Iniciando salvamento do produto:', new Date().toISOString());
    try {
        ...
        // Incluir dados de estoque sempre (criação e edição)
        ...
        console.log('📤 [DEBUG] Dados sendo enviados:', productData, new Date().toISOString());
...
async function editProduct(productId) {
    console.log('🚀 [DEBUG] Iniciando edição do produto:', productId, new Date().toISOString());
    alert('DEBUG: Editando produto ' + productId);
    try {
        ...
        console.log('🔍 [DEBUG] Dados do produto carregados:', product, new Date().toISOString());
        ...
        // Carregar dados de estoque atuais na edição
        document.getElementById('quantidade_inicial').value = product.quantidade_atual || 0;
        document.getElementById('quantidade_minima').value = product.quantidade_minima || 0;
        document.getElementById('quantidade_maxima').value = product.quantidade_maxima || '';
